...
return (
  ...
  {result && <Button onClick={handleResult} style={"bg-orange-300 px10 py-2 rounded hover:bg-orange-400 mt-3"} >Show Results</Button>}
  {start && <Button onClick={ handleStart} style={"bg-orange-300 px10 py-2 rounded hover:bg-orange-400"}>Start Quiz</Button> }
  </div>
</div>
);
}
